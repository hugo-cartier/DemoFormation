...
namespace GestionStock.Database
{
    public class DataBaseArticleManager : IDataBaseArticleManager
    {
        List<DataBaseArticle> ListeArticles = new List<DataBaseArticle>()
        {
            ...
            new DataBaseArticle("0103", "Yaourt vanille", 1.2f, 500),
            new DataBaseArticle("0105", "Yaourt chocolat", 1.3f, 500),
            new DataBaseArticle("0106", "Yaourt pistache", 1.3f, 500),
            new DataBaseArticle("0108", "Yaourt caramel", 1.3f, 500),
        };
